...
```
パターン1「カルテだけ使いたい」
  salon-karte 基本プラン = 2,980円

パターン2「カルテ + 在庫管理（確定申告もラクに）」
  基本 + 在庫管理 = 3,480円

パターン3「カルテ + 在庫 + 問診票 + LINE」
  基本 + 在庫 + カウンセリング + LINE = 5,480円

パターン4「カルテ + HP（ホットペッパー脱却）」
  salon-karte + salon-site = 6,960円
  → ホットペッパー月2.5万～ の1/4以下

パターン5「全部入り（カルテ+HP+EC+全オプション）」
  セット割 + 全オプション = 約13,760円
