    ...
    <div className="space-y-8">
      ...
      <div className="bg-accent/5 border border-accent/20 rounded-2xl p-4">
        ...
        <ul className="mt-2 space-y-1.5 text-sm text-text-light">
          {[
            ...
            "LINEで予約リマインド・来店促進メッセージを自動送信",
            "カウンセリングシート（デジタル問診票）でお客様情報を事前収集",
            "来店が途切れたお客様を自動でお知らせ",
            "顧客LTV・リピート率・メニュー別ランキングで経営を分析",
            "物販の購入履歴と回数券の残数を管理",
            "施術・物販・回数券の売上を自動集計",
            "商品の在庫管理・仕入れ・棚卸し",
            "確定申告に使える売上原価レポート・CSV出力",
            "顧客・カルテ・商品データのCSVインポート/エクスポート",
          ].map((item) => (
      ...
      <Section title="機能の詳細" icon="&#128218;">
        <div className="space-y-3">
          ...
          <FeatureCard title="カルテPDF出力" description="施術記録を印刷用PDFとして出力できます。お客様への施術報告書や、紙での保管にも対応できます。カルテ詳細画面の「PDF出力」ボタンからワンタップで作成できます。" />
          ...
          <FeatureCard title="LINE連携" description="LINE公式アカウントと接続し、予約確認通知や前日リマインドを自動送信できます。友だち追加の検知や、顧客との紐付け管理にも対応しています。「設定」→「LINE連携」から接続できます。" />
          ...
          <FeatureCard title="カウンセリングシート" description="初回来店時などにお客様自身がスマホで入力できるデジタル問診票です。テンプレートを作成し、QRコードやリンクで共有できます。回答は顧客データに自動保存されます。有効期限付きで安全に運用できます。" />
          <FeatureCard title="売上分析" description="顧客LTV（生涯売上）ランキング、新規/リピーターの月別推移、メニュー別人気ランキングを確認できます。データが蓄積されるほど経営判断に役立ちます。「経営」→「売上分析」からアクセスできます。" />
          <FeatureCard title="データエクスポート/インポート" description="顧客・施術記録・商品・予約・回数券のCSV出力に対応しています。他サービスからの乗り換え時にはCSV一括取り込みも可能です。あなたのデータはいつでも持ち出せます。「設定」→「データエクスポート」「データインポート」からアクセスできます。" />
        ...
        <div className="bg-surface border border-border rounded-2xl p-4 space-y-3">
          ...
          <ul className="space-y-2 text-sm">
            {[
              ...
              { title: "データポータビリティ", desc: "顧客・カルテ・商品などのデータはCSVでいつでもエクスポートできます。あなたのデータを人質にしません" },
            ].map(({ title, desc }) => (
