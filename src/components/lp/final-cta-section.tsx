  ...
  return (
    <section className="relative py-20 md:py-28 overflow-hidden">
      ...
      <div className="relative max-w-2xl mx-auto px-4 text-center">
        ...
        <Link
          href="/signup"
          className="inline-flex items-center justify-center bg-accent hover:bg-accent-light text-white font-bold rounded-2xl px-12 py-5 text-xl transition-all duration-300 hover:shadow-xl hover:shadow-accent/25 min-h-[64px]"
        >
          無料ではじめる
        </Link>
