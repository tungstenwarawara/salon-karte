...
const FAQ_ITEMS = [
  ...
  {
    q: "無料プランと有料プランの違いは？",
    a: "おためしプラン（無料）は顧客50人・カルテ100件・予約月30件までを目安にお使いいただけます。スタンダードプランでは全機能が無制限でお使いいただけます。まずは無料でお試しいただき、本格運用時にアップグレードいただけます。",
  },
  {
    q: "会計ソフトとの連携はできますか？",
    a: "はい。月別の売上・仕入データや在庫明細を、freee・弥生会計・マネーフォワードに取り込めるCSV形式で出力できます。確定申告の準備がぐっとラクになります。",
  },
  {
    q: "解約したらデータはどうなりますか？",
    a: "登録されたデータはすべてあなたのものです。解約前にCSVエクスポート機能で顧客・カルテ・予約・売上データを一括ダウンロードできます。会計ソフト向けCSV（freee・マネーフォワード・弥生）にも対応しています。データの囲い込みは一切ありません。",
  },
  {
    q: "困ったときはどこに相談できますか？",
