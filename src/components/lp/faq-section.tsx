...
const FAQ_ITEMS = [
  ...
  {
    q: "いつでも解約できますか？",
    a: "はい、解約の縛りはありません。管理画面からいつでもプランの変更・解約が可能です。解約後もデータは30日間保持されます。",
  },
  {
    q: "セキュリティは大丈夫ですか？",
  ...
  {
    q: "無料プランと有料プランの違いは？",
    a: "おためしプラン（無料）は顧客10件・カルテ各5件・予約月20件まで。スタンダードプランでは全機能が無制限でお使いいただけます。まずは無料でお試しいただき、本格運用時にアップグレードいただけます。",
  },
  {
