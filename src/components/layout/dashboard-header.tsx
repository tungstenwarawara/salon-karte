    ...
    <>
      ...
      <header className="sticky top-0 z-50 bg-surface border-b border-border px-4 py-3 flex items-center justify-between">
        ...
        <div className="flex items-center gap-1">
          <Link href="/settings" className="p-2.5 min-w-[44px] min-h-[44px] flex items-center justify-center text-text-light hover:text-accent transition-colors" aria-label="設定">
          ...
          <Link href="/guide" className="p-2.5 min-w-[44px] min-h-[44px] flex items-center justify-center text-text-light hover:text-accent transition-colors" aria-label="使い方ガイド">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
