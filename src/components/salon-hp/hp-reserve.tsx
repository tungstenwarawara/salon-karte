...
export function HpReserve({
  ...
  return (
    <section
      id="reserve"
      className="relative text-white sei-dark-section overflow-hidden"
    >
      {/* 背景画像 (Next.js Image で最適化) — z-0 で section 内の最下層 */}
      <Image
        src={imagePath}
        alt=""
        fill
        ...
        style={{ zIndex: 0 }}
      />
      {/* 暗オーバーレイ — 画像の上、コンテンツの下 */}
      <div
        className="absolute inset-0 pointer-events-none"
        style={{ background: "rgba(20,18,15,0.55)", zIndex: 1 }}
      />

      {/* コンテンツ — z-10 で最前面 */}
      <div
        className="relative px-[5vw] py-32 md:py-[160px] text-center"
        style={{ zIndex: 2 }}
      >
